...
bin/cnn-train example/data/train2.dat --input-dim 32x32 --output-dim 12 --base 1 --struct 10x5x5-2s-10x3x3-2s-10x3x3-2s-512-512 --batch-size 32 --learning-rate 0.01 --min-acc 0.7
# bin/cnn-train example/data/train2.dat --input-dim 32x32 --output-dim 12 --base 1 --struct 20x9x9-2s-20x5x5-2s-1024-1024 --batch-size 32
